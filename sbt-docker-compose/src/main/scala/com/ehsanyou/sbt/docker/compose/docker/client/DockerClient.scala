package com.ehsanyou.sbt.docker.compose.docker.client
...
import com.ehsanyou.sbt.docker.compose.docker.DataTypes
import com.ehsanyou.sbt.docker.compose.docker.DataTypes.PortMapping
import com.ehsanyou.sbt.docker.compose.docker.DataTypes.{ContainerInfo => CustomContainerInfo}
