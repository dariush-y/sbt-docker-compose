...
import com.ehsanyou.sbt.docker.compose.HealthCheckActor
import com.ehsanyou.sbt.docker.compose.HealthCheckActor.Protocol
...
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.{Test => TestDT}
