...
import com.ehsanyou.sbt.docker.compose.Keys.dockerComposeFilePath
import com.ehsanyou.sbt.docker.compose.Keys.dockerComposeIgnore
import com.ehsanyou.sbt.docker.compose.commands.dc.{DockerCompose => DockerComposeCommand}
import com.ehsanyou.sbt.docker.compose.commands.down.DockerComposeDown
...
import com.ehsanyou.sbt.docker.compose.commands.test
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.ItTest
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.ItTestOnly
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.ItTestQuick
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.Test
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.TestOnly
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.TestQuick
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTest.TestType
import com.ehsanyou.sbt.docker.compose.commands.test.DockerComposeTestCmd
import com.ehsanyou.sbt.docker.compose.commands.test.{DockerComposeTest => DockerComposeTestDT}
import com.ehsanyou.sbt.docker.compose.commands.up.DockerComposeUp
